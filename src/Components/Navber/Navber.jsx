      ...
      <div className="container">
        <div className="navHead flex justify-between">
          <div className="logo flex items-center ">
            <img className='w-[95px] h-[80px] border-solid border-[4px] border-[#FB4141] rounded-[50%] p-[2px]' src="https://static.vecteezy.com/system/resources/thumbnails/024/553/853/small_2x/colorful-eagle-head-logo-pop-art-style-eagle-face-sticker-pastel-cute-colors-ai-generated-png.png" alt="" />
            <h1 className='ml-4 text-3xl font-bold dark:text-gray-200'>NoteSpoty</h1>
          </div>
